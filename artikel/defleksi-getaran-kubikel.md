---
article_id: KBI-05-04
title: "Defleksi, Getaran, dan Pintu yang Membanting sebagai Gejala Struktur"
slug: "defleksi-getaran-kubikel"
description: "Separate support movement, hardware adjustment, panel flexibility, and external vibration"
status: outline
publication_date: "2025-10-02"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KBI-05
primary_intent: "Diagnose movement symptoms"
reader_community: "Kubikel.co.id"
reader_address: "Sobat Kubikel.co.id"
final_route: "/artikel/defleksi-getaran-kubikel.html"
...
# Defleksi, Getaran, dan Pintu yang Membanting sebagai Gejala Struktur

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Defleksi, Getaran, dan Pintu yang Membanting sebagai Gejala Struktur”
- **Reader and situation:** Facility manager seeing wobble/noise
- **Reader outcome:** Separate support movement, hardware adjustment, panel flexibility, and external vibration
- **Primary intent:** Diagnose movement symptoms
...
- **Scope boundary:** Does not clear continued use; KBI-14-01 owns triage and engineer owns safety
- **Final public route:** `/artikel/defleksi-getaran-kubikel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Defleksi, Getaran, dan Pintu yang Membanting sebagai Gejala Struktur**.
...
- `KBI-05-02` → `/artikel/anchor-kubikel-berdasarkan-substrat.html` — Memilih Anchor Kubikel Sesuai Beton, Bata, Gypsum, atau Lantai Berlapis
- `KBI-05-03` → `/artikel/anchor-kubikel-dan-waterproofing.html` — Penetrasi Anchor pada Area Basah tanpa Merusak Waterproofing
- `KBI-05-05` → `/artikel/dukungan-struktural-kubikel-kaca.html` — Dukungan Kubikel Kaca: Tepi, Lubang, Kontak Keras, dan Penggantian
- `KBI-05-06` → `/artikel/kubikel-pada-bangunan-bergerak.html` — Kubikel pada Bangunan Bergerak atau Rawan Gempa: Pertanyaan Desainnya
...
- **Tie back to this article:** Keep the explanation specific to “Defleksi, Getaran, dan Pintu yang Membanting sebagai Gejala Struktur”.
