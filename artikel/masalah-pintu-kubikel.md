---
article_id: KBI-14-03
title: "Pintu Kubikel Seret, Turun, atau Tidak Mengunci: Urutan Pemeriksaan"
slug: "masalah-pintu-kubikel"
description: "Check obstruction, alignment, support movement, hinges, latch, closer, and parts records"
status: outline
publication_date: "2026-05-04"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KBI-14
primary_intent: "Diagnose door operation"
reader_community: "Kubikel.co.id"
reader_address: "Sobat Kubikel.co.id"
final_route: "/artikel/masalah-pintu-kubikel.html"
...
# Pintu Kubikel Seret, Turun, atau Tidak Mengunci: Urutan Pemeriksaan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pintu Kubikel Seret, Turun, atau Tidak Mengunci: Urutan Pemeriksaan”
- **Reader and situation:** Maintenance team
- **Reader outcome:** Check obstruction, alignment, support movement, hinges, latch, closer, and parts records
- **Primary intent:** Diagnose door operation
...
- **Scope boundary:** Unsafe support movement escalates to KBI-05-04; no unqualified repair instruction
- **Final public route:** `/artikel/masalah-pintu-kubikel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pintu Kubikel Seret, Turun, atau Tidak Mengunci: Urutan Pemeriksaan**.
...
- `KBI-14-01` → `/artikel/triage-kerusakan-kubikel.html` — Triage Kerusakan Kubikel: Aman Dipakai, Batasi Akses, atau Tutup?
...
- `KBI-14-04` → `/artikel/kaca-kubikel-retak-atau-pecah.html` — Kaca Kubikel Retak atau Pecah: Amankan Area dan Simpan Bukti
...
- **Tie back to this article:** Keep the explanation specific to “Pintu Kubikel Seret, Turun, atau Tidak Mengunci: Urutan Pemeriksaan”.
