---
article_id: KBI-01-04
title: "Kubikel Listrik, Panel, dan Switchgear Bukan Selalu Benda yang Sama"
slug: "beda-kubikel-listrik-panel-switchgear"
description: "Show entity hierarchy and questions needed before specifying a name"
status: outline
publication_date: "2025-07-02"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KBI-01
primary_intent: "Clarify electrical terminology"
reader_community: "Kubikel.co.id"
reader_address: "Teman Kubikel.co.id"
final_route: "/artikel/beda-kubikel-listrik-panel-switchgear.html"
...
# Kubikel Listrik, Panel, dan Switchgear Bukan Selalu Benda yang Sama

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kubikel Listrik, Panel, dan Switchgear Bukan Selalu Benda yang Sama”
- **Reader and situation:** Non-specialist discussing electrical equipment
- **Reader outcome:** Show entity hierarchy and questions needed before specifying a name
- **Primary intent:** Clarify electrical terminology
...
- **Scope boundary:** Does not explain configurations; KBI-09-02 owns them
- **Final public route:** `/artikel/beda-kubikel-listrik-panel-switchgear.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kubikel Listrik, Panel, dan Switchgear Bukan Selalu Benda yang Sama**.
...
- `KBI-01-03` → `/artikel/beda-kubikel-partisi-bilik-workstation.html` — Kubikel, Partisi, Bilik, dan Workstation: Apa Bedanya?
...
- `KBI-01-06` → `/artikel/sejarah-istilah-kubikel.html` — Bagaimana Istilah Kubikel Berkembang dari Bilik ke Sistem Teknik
...
- **Tie back to this article:** Keep the explanation specific to “Kubikel Listrik, Panel, dan Switchgear Bukan Selalu Benda yang Sama”.
