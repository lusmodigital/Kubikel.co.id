---
article_id: KBI-11-04
title: "Mock-up dan Sampel Kubikel: Apa yang Diuji dan Siapa yang Menyetujui"
slug: "mock-up-dan-sampel-kubikel"
description: "Separate finish sample, hardware sample, detail mock-up, and full-scale user trial"
status: outline
publication_date: "2026-02-26"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KBI-11
primary_intent: "Plan preproduction validation"
reader_community: "Kubikel.co.id"
reader_address: "Teman Kubikel.co.id"
final_route: "/artikel/mock-up-dan-sampel-kubikel.html"
...
# Mock-up dan Sampel Kubikel: Apa yang Diuji dan Siapa yang Menyetujui

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mock-up dan Sampel Kubikel: Apa yang Diuji dan Siapa yang Menyetujui”
- **Reader and situation:** Project team
- **Reader outcome:** Separate finish sample, hardware sample, detail mock-up, and full-scale user trial
- **Primary intent:** Plan preproduction validation
...
- **Scope boundary:** Factory trial assembly belongs to KBI-12-05
- **Final public route:** `/artikel/mock-up-dan-sampel-kubikel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mock-up dan Sampel Kubikel: Apa yang Diuji dan Siapa yang Menyetujui**.
...
- `KBI-11-02` → `/artikel/module-schedule-kubikel.html` — Membuat Module Schedule Kubikel agar Jumlah dan Ukuran Tidak Tertukar
- `KBI-11-03` → `/artikel/isi-shop-drawing-kubikel.html` — Isi Shop Drawing Kubikel yang Harus Disetujui sebelum Produksi
- `KBI-11-05` → `/artikel/spesifikasi-kubikel-berbasis-kinerja.html` — Spesifikasi Kubikel Berbasis Kinerja tanpa Mengunci Merek
- `KBI-11-06` → `/artikel/matriks-interface-kubikel.html` — Matriks Interface Kubikel dengan Arsitektur, Struktur, MEP, dan Operasi
...
- **Tie back to this article:** Keep the explanation specific to “Mock-up dan Sampel Kubikel: Apa yang Diuji dan Siapa yang Menyetujui”.
