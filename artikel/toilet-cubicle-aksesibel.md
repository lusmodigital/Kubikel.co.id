---
article_id: KBI-07-03
title: "Toilet Cubicle Aksesibel: Ruang Gerak, Transfer, Pegangan, dan Pintu"
slug: "toilet-cubicle-aksesibel"
description: "Map user tasks and coordination points that must follow current applicable rules"
status: outline
publication_date: "2025-11-15"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KBI-07
primary_intent: "Understand inclusive-access requirements"
reader_community: "Kubikel.co.id"
reader_address: "Sobat Kubikel.co.id"
final_route: "/artikel/toilet-cubicle-aksesibel.html"
...
# Toilet Cubicle Aksesibel: Ruang Gerak, Transfer, Pegangan, dan Pintu

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Toilet Cubicle Aksesibel: Ruang Gerak, Transfer, Pegangan, dan Pintu”
- **Reader and situation:** Owner/architect
- **Reader outcome:** Map user tasks and coordination points that must follow current applicable rules
- **Primary intent:** Understand inclusive-access requirements
...
- **Scope boundary:** Not a compliance drawing; qualified accessibility professional owns approval
- **Final public route:** `/artikel/toilet-cubicle-aksesibel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Toilet Cubicle Aksesibel: Ruang Gerak, Transfer, Pegangan, dan Pintu**.
...
- `KBI-07-01` → `/artikel/merencanakan-toilet-cubicle.html` — Merencanakan Toilet Cubicle dari Pengguna, Fixture, dan Alur Ruang
- `KBI-07-02` → `/artikel/arah-bukaan-pintu-toilet-cubicle.html` — Arah Bukaan Pintu Toilet Cubicle dan Dampaknya pada Keselamatan
- `KBI-07-04` → `/artikel/celah-privasi-toilet-cubicle.html` — Celah Privasi Toilet: Menyeimbangkan Pandangan, Ventilasi, dan Toleransi
...
- **Tie back to this article:** Keep the explanation specific to “Toilet Cubicle Aksesibel: Ruang Gerak, Transfer, Pegangan, dan Pintu”.
