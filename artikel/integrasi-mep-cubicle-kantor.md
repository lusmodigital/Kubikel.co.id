---
article_id: KBI-06-05
title: "Integrasi Kabel, Stopkontak, Data, Lampu, dan AC pada Cubicle Kantor"
slug: "integrasi-mep-cubicle-kantor"
description: "Map safe routes, access, heat, trip hazards, maintenance, and change control"
status: outline
publication_date: "2025-11-01"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KBI-06
primary_intent: "Coordinate building services"
reader_community: "Kubikel.co.id"
reader_address: "Teman Kubikel.co.id"
final_route: "/artikel/integrasi-mep-cubicle-kantor.html"
...
# Integrasi Kabel, Stopkontak, Data, Lampu, dan AC pada Cubicle Kantor

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Integrasi Kabel, Stopkontak, Data, Lampu, dan AC pada Cubicle Kantor”
- **Reader and situation:** Office fit-out team
- **Reader outcome:** Map safe routes, access, heat, trip hazards, maintenance, and change control
- **Primary intent:** Coordinate building services
...
- **Scope boundary:** Electrical design belongs to qualified professionals; KBI-10 does not cover office wiring design
- **Final public route:** `/artikel/integrasi-mep-cubicle-kantor.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Integrasi Kabel, Stopkontak, Data, Lampu, dan AC pada Cubicle Kantor**.
...
- `KBI-06-03` → `/artikel/privasi-visual-dan-tinggi-panel-kantor.html` — Privasi Visual vs Kolaborasi pada Tinggi Panel Kantor
- `KBI-06-04` → `/artikel/akustik-cubicle-kantor.html` — Mengapa Panel Kantor Tidak Otomatis Membuat Percakapan Rahasia
- `KBI-06-06` → `/artikel/cubicle-modular-untuk-perubahan-tim.html` — Cubicle Modular untuk Tim yang Sering Berubah: Apa yang Benar-Benar Fleksibel?
...
- **Tie back to this article:** Keep the explanation specific to “Integrasi Kabel, Stopkontak, Data, Lampu, dan AC pada Cubicle Kantor”.
