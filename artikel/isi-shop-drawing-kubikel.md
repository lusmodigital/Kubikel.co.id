---
article_id: KBI-11-03
title: "Isi Shop Drawing Kubikel yang Harus Disetujui sebelum Produksi"
slug: "isi-shop-drawing-kubikel"
description: "List plans, elevations, sections, interfaces, tolerances, schedules, notes, and revision status"
status: outline
publication_date: "2026-02-22"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KBI-11
primary_intent: "Review shop drawings"
...
# Isi Shop Drawing Kubikel yang Harus Disetujui sebelum Produksi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Isi Shop Drawing Kubikel yang Harus Disetujui sebelum Produksi”
- **Reader and situation:** Consultant/owner
- **Reader outcome:** List plans, elevations, sections, interfaces, tolerances, schedules, notes, and revision status
- **Primary intent:** Review shop drawings
...
- **Scope boundary:** Fabrication inspection belongs to KBI-12-01
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Isi Shop Drawing Kubikel yang Harus Disetujui sebelum Produksi**.
...
- `KBI-11-01` → `/artikel/cara-mengukur-lokasi-kubikel.html` — Cara Mengukur Lokasi Kubikel dan Mencatat Ketidakrataan
- `KBI-11-02` → `/artikel/module-schedule-kubikel.html` — Membuat Module Schedule Kubikel agar Jumlah dan Ukuran Tidak Tertukar
- `KBI-11-04` → `/artikel/mock-up-dan-sampel-kubikel.html` — Mock-up dan Sampel Kubikel: Apa yang Diuji dan Siapa yang Menyetujui
...
- **Tie back to this article:** Keep the explanation specific to “Isi Shop Drawing Kubikel yang Harus Disetujui sebelum Produksi”.
