---
article_id: KBI-14-04
title: "Kaca Kubikel Retak atau Pecah: Amankan Area dan Simpan Bukti"
slug: "kaca-kubikel-retak-atau-pecah"
description: "Define isolation, injury prevention, evidence preservation, specialist investigation, and replacement questions"
status: outline
publication_date: "2026-05-08"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KBI-14
primary_intent: "Respond to glass failure"
reader_community: "Kubikel.co.id"
reader_address: "Sobat Kubikel.co.id"
final_route: "/artikel/kaca-kubikel-retak-atau-pecah.html"
...
# Kaca Kubikel Retak atau Pecah: Amankan Area dan Simpan Bukti

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kaca Kubikel Retak atau Pecah: Amankan Area dan Simpan Bukti”
- **Reader and situation:** Facility manager
- **Reader outcome:** Define isolation, injury prevention, evidence preservation, specialist investigation, and replacement questions
- **Primary intent:** Respond to glass failure
...
- **Scope boundary:** No glass handling/replacement procedure; glass specialist owns it
- **Final public route:** `/artikel/kaca-kubikel-retak-atau-pecah.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kaca Kubikel Retak atau Pecah: Amankan Area dan Simpan Bukti**.
...
- `KBI-14-02` → `/artikel/kerusakan-permukaan-panel-kubikel.html` — Panel Kubikel Mengembung, Mengelupas, atau Berubah Warna: Penyebabnya
- `KBI-14-03` → `/artikel/masalah-pintu-kubikel.html` — Pintu Kubikel Seret, Turun, atau Tidak Mengunci: Urutan Pemeriksaan
- `KBI-14-05` → `/artikel/baseline-inspeksi-kubikel-listrik.html` — Baseline Inspeksi Kubikel Listrik tanpa Membuka Peralatan
- `KBI-14-06` → `/artikel/memperbaiki-retrofit-atau-mengganti-kubikel.html` — Memperbaiki, Retrofit, atau Mengganti Kubikel: Kerangka Keputusan
...
- **Tie back to this article:** Keep the explanation specific to “Kaca Kubikel Retak atau Pecah: Amankan Area dan Simpan Bukti”.
