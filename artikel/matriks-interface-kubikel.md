---
article_id: KBI-11-06
title: "Matriks Interface Kubikel dengan Arsitektur, Struktur, MEP, dan Operasi"
slug: "matriks-interface-kubikel"
description: "Assign inputs, outputs, decisions, dates, and owners across systems"
status: outline
...
final_route: "/artikel/matriks-interface-kubikel.html"
...
# Matriks Interface Kubikel dengan Arsitektur, Struktur, MEP, dan Operasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Matriks Interface Kubikel dengan Arsitektur, Struktur, MEP, dan Operasi”
- **Reader and situation:** Project manager
- **Reader outcome:** Assign inputs, outputs, decisions, dates, and owners across systems
...
- **Scope boundary:** Does not perform discipline designs; respective professionals retain responsibility
- **Final public route:** `/artikel/matriks-interface-kubikel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Matriks Interface Kubikel dengan Arsitektur, Struktur, MEP, dan Operasi**.
...
- **Tie back to this article:** Keep the explanation specific to “Matriks Interface Kubikel dengan Arsitektur, Struktur, MEP, dan Operasi”.
